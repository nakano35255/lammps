...
#ifdef COMPUTE_CLASS
// clang-format off
ComputeStyle(hexorder/atom/mod,ComputeHexOrderAtomMod);
// clang-format on
#else

#ifndef LMP_COMPUTE_HEXORDER_ATOM_MOD_H
#define LMP_COMPUTE_HEXORDER_ATOM_MOD_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeHexOrderAtomMod : public Compute {
 public:
  ComputeHexOrderAtomMod(class LAMMPS *, int, char **);
  ~ComputeHexOrderAtomMod();
  void init();
